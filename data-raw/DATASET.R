...
# Stairmand
stairmand <- list(default = c(0.315, 0.157, 1.265, 0.157, 0.157, 0.0627))

# Muschelknautz
muschelknautz <- list(default = c(0.680, 0.170, 0.934, 0.311, 0.173, 0.058))

# Loffler
loffler <- list(default = c(1.260, 0.420, 2.500, 0.650, 0.600, 0.200))
