...
eskal <- list(
  Rhop = 2700,
  intervals = c(0, 0.9, 1.1, 1.3, 1.8, 2.6, 3.7, 5, 7.5, 10.5, 15, 21, 30, 43, 61, 87) * 1e-6,
  delta500 = c(0, 3.63, 1.69, 1.7, 4.7, 9.84, 18.01, 22.41, 28.1, 8.52, 1.26, 0.14) / 100,
  delta10 = c(0, 1.22, 0.49, 0.44, 0.92, 0.99, 0.81, 1.45, 15.22, 30.77, 31.51, 13.77, 2.28, 0.13) / 100,
  delta15 = c(0, 1.75, 0.46, 0.33, 0.49, 0.41, 0.36, 0.38, 0.39, 3.64, 24.16, 45.95, 20.07, 1.61) / 100,
  delta20 = c(0, 0.96, 0.31, 0.26, 0.45, 0.43, 0.36, 0.32, 0.68, 1.82, 10.34, 30.24, 39.78, 12.96, 1.09) / 100
)
...
esqua <- list(
  Rhop = 2630,
  intervals = c(0, 0.9, 1.1, 1.3, 1.8, 2.6, 3.7, 5, 7.5, 10.5, 15, 21, 30, 43, 61, 87, 123, 175) * 1e-6,
  delta7 = c(0, 10.86, 4.17, 3.58, 7.01, 7.79, 7.45, 6.94, 10.75, 9.66, 10.53, 9.1, 6.7, 3.57, 1.49, 0.4) / 100,
  delta15 = c(0, 5.37, 2.09, 1.82, 2.81, 5.02, 4.36, 4.45, 7.6, 7.75, 9.77, 10.49, 11.92, 12.34, 9.5, 4.16, 0.55) / 100,
  delta25 = c(0, 3.83, 1.48, 1.28, 2.53, 2.93, 3.04, 3.16, 5.52, 5.74, 7.44, 8.25, 9.78, 11.26, 12.39, 11.88, 7.65, 1.84) / 100
)
...
usethis::use_data(esqua, overwrite = TRUE)
